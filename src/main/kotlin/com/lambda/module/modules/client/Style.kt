...
object Style : Module(
	...
	val blur = setting("Enable Blur", true, "Blurs the game behind windows for a frosted-glass look")
	val blurRadius = setting("Blur Radius", 12f, 1f..32f, 1f, "Strength of the frosted-glass blur") { blur.value }
	...
	@Group(DARK_THEME_GROUP) private val darkTheme: LambdaColorSettings by configBlock(
		LambdaColorSettings(
			...
			surface = Color(18, 0, 8, 80),
			surfaceVariant = Color(35, 3, 18, 80),
			...
			moduleDisabled = Color(40, 5, 22, 0),
	...
	@Group(LIGHT_THEME_GROUP) private val lightTheme: LambdaColorSettings by configBlock(
		LambdaColorSettings(
			...
			surface = Color(250, 244, 246, 80),
			surfaceVariant = Color(240, 226, 232, 80),
			...
			moduleDisabled = Color(236, 228, 231, 0),
